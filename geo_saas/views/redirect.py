...
from geo_saas import get_allowed_hosts

LOG = logging.getLogger(__name__)

param_name = os.environ.get("geo_saas_PARAM", "came_from")

geo_saas_service = Service(name="geo_saas", description="The geo_saas service", path="/")


@geo_saas_service.get()
def geo_saas_get(request: pyramid.request.Request) -> Any:
